...
var WEBSITENAME="vuial"; //网站名称
var ABOUTID = 12; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
var PAGECOUNT='10'; //每页文章数目
var CATEGORIESID='all'  //专题页显示全部的分类all全部
//var CATEGORIESID = '1,1059,98,416,189,374,6,463';//指定专题页显示的分类的id
var INDEXLISTTYPE="1" //首页显示所有分类
//var INDEXLISTTYPE ="1" //指定首页显示分类的id
var PAYTEMPPLATEID = '42dMv4fn2TgyjegzpFDMRF6JRGMr8UXqwCWuKImuK88';//赞赏消息模版id
var REPLAYTEMPPLATEID = 'oSbiynsu932P2wHiaVOiMpekp41XmOB8cX_ckNcAnfg';//回复评论消息模版id
var ZANIMAGEURL = 'https://surao.top/img/weixins.png';//微信赞赏的图片链接，用于个人小程序的赞赏
...
var DOWNLOADFILEDOMAIN = [
  { id: 1, domain: 'vuial.cn' },
  { id: 2, domain: 'vuial.cn' },
  { id: 3, domain: 'vuial.cn' }
]
 //首页图标导航
